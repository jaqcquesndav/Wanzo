    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Section pour les dernières ventes et produits faibles en stock (responsive)
          _buildSalesAndStockLayout(),
        ],
      ),
    );
  }

  /// Construit la section responsive pour les ventes récentes et le stock faible
  Widget _buildSalesAndStockLayout() {
    return LayoutBuilder(
      builder: (context, constraints) {
        // Définir un seuil pour les petits écrans, par exemple 600 pixels de large
        if (constraints.maxWidth < 600) {
          // Afficher en colonne pour les petits écrans
          return Column(
            children: [
              _buildRecentSales(),
              const SizedBox(height: WanzoSpacing.md),
          ...
          // Afficher en ligne pour les écrans plus larges
          return Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Expanded(
