...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingPage> _pages = [
    OnboardingPage(
      ...
      description: 'Enregistrez facilement vos ventes, émettez des factures et suivez vos revenus en temps réel.',
      icon: Icons.shopping_cart,
    ),
    OnboardingPage(
      title: 'Contrôlez votre stock',
      description: 'Suivez votre inventaire, recevez des alertes de stock bas et gérez vos approvisionnements.',
      icon: Icons.inventory,
    ),
    OnboardingPage(
      title: 'Analysez vos données',
      description: 'Visualisez vos performances commerciales et prenez des décisions éclairées grâce aux tableaux de bord.',
      icon: Icons.bar_chart,
    ),
    OnboardingPage(
      title: 'Travaillez partout',
      description: 'Accédez à vos données même sans connexion internet et synchronisez-les quand vous êtes en ligne.',
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            fontSize: WanzoTypography.fontSizeMd,
                            fontWeight: WanzoTypography.fontWeightNormal,
                          ),
                          textAlign: TextAlign.center,
                        ),
                      ],
